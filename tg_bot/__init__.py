...
class Bot:
    ...
    async def start(self, update: Update, context: CallbackContext):
        ...
        if not user.is_registered:
            await tgUser.send_message("Ushbu bot YASAR kompaniyasi tomonidan o'tkazilgan maxsus aksiya uchun tashkil qilingan\n\nAksiya bo'yicha savollarga javob olish uchun +998990119090 raqamiga murojaat qilishingiz mumkin.")
