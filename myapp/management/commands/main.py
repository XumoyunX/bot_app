...
async def myapp(update: Update, context: ContextTypes):
    ...
    if state == "name":
        ...
        my_model_instance, created = Users.objects.get_or_create(chat_id=chat_id)
...
app = ApplicationBuilder().token("5324045923:AAFUBC5cNbCMtdLiIq-PHY_sa-5Wx3O8des").build()
